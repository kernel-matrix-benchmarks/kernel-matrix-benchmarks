...
# Product on the cube:
python3 run.py --local --dataset product-cube-D3-E1-M1000-N1000-gaussian
python3 run.py --local --dataset product-cube-D3-E1-M2000-N2000-gaussian
#python3 run.py --local --dataset product-cube-D3-E1-M5000-N5000-gaussian
#python3 run.py --local --dataset product-cube-D3-E1-M10000-N10000-gaussian

# Solver on the cube:
python3 run.py --local --dataset solver-cube-D3-E1-M1000-N1000-gaussian
python3 run.py --local --dataset solver-cube-D3-E1-M2000-N2000-gaussian
#python3 run.py --local --dataset solver-cube-D3-E1-M5000-N5000-gaussian
#python3 run.py --local --dataset solver-cube-D3-E1-M10000-N10000-gaussian
